...
const defaultCachev2: RuntimeCaching[] = [
  {
  ...
  {
    matcher: ({ sameOrigin, url: { pathname } }: any) => {
  ...
  {
    matcher: ({ request, url: { pathname }, sameOrigin }: any) =>
  ...
  {
    matcher: ({ url: { pathname }, sameOrigin }: any) =>
  ...
  {
    matcher: ({ sameOrigin }: any) => !sameOrigin,
    handler: new NetworkFirst({
